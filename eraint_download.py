...
looping through several years. For the parameter table see
...
# Get levels every 50mb starting 1000mb. See:
...
# levs = 58  # testing
# hours = 12  # testing
# years = [(2010, 2010)]  # testing
for year in years:
    for month in (1, 7):
        # Temperature tendency
        filename = f'{base}/mlevs/tdt_{year[0]:04d}-{year[1]:04d}_{month:02d}.grb2'
        print(f'\n\n\nTemperature tendency for years {year}, months {month}, file {filename}.')  # noqa: E501
        download.era(
            ('tdt', 'msp'),
            'oper',
            'ml',
        ...
        # print(f'\n\n\nSurface pressure for years {year}, months {month}, file {filename}.')  # noqa: E501
        # download.era(
        #     'msp',
        #     'oper',
        #     'ml',
